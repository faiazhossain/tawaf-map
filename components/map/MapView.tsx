...
// Barikoi map styling is loaded through a same-origin proxy so browser CORS
// does not block the basemap request. The upstream API key stays server-side.
const BARIKOI_MAP_STYLE = "/api/barikoi-style";
