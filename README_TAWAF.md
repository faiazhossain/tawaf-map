...
| **U6** — দোয়া অডিও + অফলাইন + পলিশ           | বাংলা/আরবি তেলাওয়াত, অফলাইন বান্ডলিং, হুইলচেয়ার পথ, "হারিয়ে গেছি" সহায়ক                                                    | **আংশিক** (অফলাইন সূচক সম্পন্ন; অডিও ও সহায়ক বাকি) |
...
npm run test                # ভিটেস্ট ইউনিট (৬৫ টেস্ট)
npm run test:e2e            # প্লেরাইট e2e (গাইড, মানচিত্র, ভুল সহায়ক, মিকাত ফ্লো)
```

ইউনিট: `tests/unit/umrah-content.test.ts` (৩৪), `umrah-sequence.test.ts` (২৯, গেট সুপারিশ সহ)।
e2e: `tests/e2e/umrah-guide.spec.ts`, `umrah-map.spec.ts`, `umrah-mistake.spec.ts`, `umrah-miqat.spec.ts`।
...
components/umrah/                   # UmrahOnboarding, UmrahStepList, MistakeAssistant, FlightIhramCard, MiqatOverviewPanel, OfflineBadge
